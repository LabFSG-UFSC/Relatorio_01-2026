...
O código-fonte completo do pipeline está disponível em [Apêndice — ETL PySpark](scripts.qmd#sec-script-etl).
...
O script completo está disponível em [Apêndice — Script de Detecção de Outliers](scripts.qmd#sec-script-outliers).
...
prioridade sobre os mais permissivos. O código-fonte completo do motor está disponível em [Apêndice — Geocoder V3](scripts.qmd#sec-script-geocoder).
...
Toda a modelagem foi devidamente mapeada no Dicionário de Dados oficial ([`DICIONARIO_DADOS.md`](evidencias.qmd#sec-dic-dados) v3).
...
*Análise completa disponível em [Apêndice — Análise Exploratória (Vias Curtas)](relatorios.qmd#sec-rel-vias-curtas).*
...
*Análise completa disponível em [Apêndice — Análise de Lote/Terreno V3](relatorios.qmd#sec-rel-lote-terreno).*
...
*Análise completa disponível em [Apêndice — Análise Estatística V3](relatorios.qmd#sec-rel-estatistica) e [Avaliação CNEFE V3](relatorios.qmd#sec-rel-cnefe).*
...
ajuste de threshold — está documentada na [Seção 3.2](#sec-lote-terreno) e no [Apêndice — Análise de Lote/Terreno](relatorios.qmd#sec-rel-lote-terreno).
