...
maneira suficientemente precisa, mantendo o poder de explicação da formação
destes valores.
...
A análise explotarória de dados foi feita com auxílio do R, versão `{r} I(version)`.
